...
router.delete("/delete", auth.isAuthenticated, authCtrl.deleteUser);
...
router.post(
  "/upload/file",
  auth.isAuthenticated,
  multer({ storage: multer.memoryStorage() }).single("fileUploader"),
